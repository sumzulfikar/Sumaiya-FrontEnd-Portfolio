                ...
                <div>
                    ...
                    <div className="mx-1 p-2 m-1 rounded-xl col-span-5  text-gray-900 bg-white shadow-lg text-align:left">
                        ...
                        <div className="pt-2 flex justify-center">
                            <button className="flex items-center px-4 py-2 align-middle bg-gray-900 text-stone-50 rounded-full mx-5 pt-2" onClick={openCalendar}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
