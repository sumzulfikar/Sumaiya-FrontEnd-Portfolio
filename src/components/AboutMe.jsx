            ...
            <div className="flex flex-row  max-sm:flex-wrap gap-4 ">
                ...
                <div>
                    ...
                    <div className="mt-4 rounded-xl col-span-8 bg-white shadow-lg">
                        ...
                        <p className="text-wrap p-5"> <p className=" font-semibold">Putting User Need First</p> Embarking on an exciting journey as a Front-End Developer, I am here to build products that customers love.
